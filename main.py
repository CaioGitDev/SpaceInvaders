...
class Player(Ship):
    ...
    def healthbar(self, window):
        ...
        pygame.draw.rect(window, COLOR_GREEN,
                         (self.x, self.y + self.ship_img.get_height() + 10,
...
def main():
    ...
    def redraw_window():
        ...
        if lost:
            lost_label = lost_font.render("You Lost!", True, COLOR_WHITE)
...
def main_menu():
    ...
    while run:
        ...
        for event in pygame.event.get():
            WIN.blit(BACKGROUND, (0, 0))
            title_label = title_font.render("Press the mouse to begin...", True, COLOR_WHITE)
